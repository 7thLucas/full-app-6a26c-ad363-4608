...
Restaurants, Cafés, Hotels, Bakeries, Bars, Fast Food, Food Courts, Lounges
...
- **Primary Colors:** Deep blue (#1E3A5F) and amber (#F59E0B)
...
- Receipt printing
- Offline support with local storage and queued sync
...
### 10. Seed/Demo Data
- Sample tenant, branches, users for all roles, products, orders, inventory
...
All tables include foreign keys, indexes, and constraints. All records carry tenant_id + branch_id.

## API Surface

RESTful APIs: /api/auth, /api/users, /api/branches, /api/products, /api/orders, /api/customers, /api/inventory, /api/reports, /api/hotel
